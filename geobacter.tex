...
We present a methodology combining Multi-objective Optimization based global analysis of properties of metabolic networks with local properties. A tool implementing this methodology is presented, and demonstrated by comparing two species of Geobacter.
...
\label{fig:heatmap}
\end{figure}
\todo{maybe list essential genes?}
\todo{all graphs: explain axes in caption}
