...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{Finding outlying genes of by their correlation with Pareto front position. The kernel density plots illustrate that activation of most gene sets is due to genetic drift, and hence normally distributed. Genes outlying this normal distribution are selected for further investigation.}
